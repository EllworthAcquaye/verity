...
export default async function DashboardPage() {
  ...
  return <>
    ...
    <section className="grid gap-4 xl:grid-cols-[1.4fr_1fr]">
      <Card><CardHeader><CardTitle>Governed workflow</CardTitle><CardDescription>Configuration is live; execution and remediation unlock in the next phases.</CardDescription></CardHeader><CardContent className="space-y-3">
