...
export default async function DashboardPage() {
  ...
  return <>
    ...
    <section className="grid gap-4 xl:grid-cols-[1.4fr_1fr]">
      <Card><CardHeader><CardTitle>Governed workflow</CardTitle><CardDescription>Configuration, isolated execution, independent approval, staging verification, promotion and audit are live.</CardDescription></CardHeader><CardContent className="space-y-3">
